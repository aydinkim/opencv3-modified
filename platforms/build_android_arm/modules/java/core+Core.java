...
public class Core {
    ...
    public static void divide(double scale, Mat src2, Mat dst, int dtype)
    {
        ...
        divide_0(scale, src2.nativeObj, dst.nativeObj, dtype);
    ...
    public static void divide(double scale, Mat src2, Mat dst)
    {
        ...
        divide_1(scale, src2.nativeObj, dst.nativeObj);
    ...
    public static void divide(Mat src1, Mat src2, Mat dst, double scale, int dtype)
    {
        ...
        divide_2(src1.nativeObj, src2.nativeObj, dst.nativeObj, scale, dtype);
    ...
    public static void divide(Mat src1, Mat src2, Mat dst, double scale)
    {
        ...
        divide_3(src1.nativeObj, src2.nativeObj, dst.nativeObj, scale);
    ...
    public static void divide(Mat src1, Mat src2, Mat dst)
    {
        ...
        divide_4(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    // C++:  void divide(double scale, Mat src2, Mat& dst, int dtype = -1)
    private static native void divide_0(double scale, long src2_nativeObj, long dst_nativeObj, int dtype);
    private static native void divide_1(double scale, long src2_nativeObj, long dst_nativeObj);
    ...
    // C++:  void divide(Mat src1, Mat src2, Mat& dst, double scale = 1, int dtype = -1)
    private static native void divide_2(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, double scale, int dtype);
    private static native void divide_3(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, double scale);
    private static native void divide_4(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);
