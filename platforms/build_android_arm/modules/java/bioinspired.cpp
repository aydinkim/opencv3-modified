...
#include "/home/aydinkim/clab/opencv_contrib/modules/bioinspired/include/opencv2/bioinspired/retina.hpp"
#include "/home/aydinkim/clab/opencv_contrib/modules/bioinspired/include/opencv2/bioinspired/retinafasttonemapping.hpp"
#include "/home/aydinkim/clab/opencv_contrib/modules/bioinspired/include/opencv2/bioinspired/transientareassegmentationmodule.hpp"
...
//
//  Ptr_RetinaFastToneMapping createRetinaFastToneMapping(Size inputSize)
//

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetinaFastToneMapping_10 (JNIEnv*, jclass, jdouble, jdouble);

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetinaFastToneMapping_10
  (JNIEnv* env, jclass , jdouble inputSize_width, jdouble inputSize_height)
{
    static const char method_name[] = "bioinspired::createRetinaFastToneMapping_10()";
    try {
        LOGD("%s", method_name);
        ...
        Ptr_RetinaFastToneMapping _retval_ = cv::bioinspired::createRetinaFastToneMapping( inputSize );
...
//
//  Ptr_Retina createRetina(Size inputSize)
//

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetina_10 (JNIEnv*, jclass, jdouble, jdouble);

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetina_10
  (JNIEnv* env, jclass , jdouble inputSize_width, jdouble inputSize_height)
{
    static const char method_name[] = "bioinspired::createRetina_10()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::bioinspired::Retina> Ptr_Retina;
        Size inputSize((int)inputSize_width, (int)inputSize_height);
        Ptr_Retina _retval_ = cv::bioinspired::createRetina( inputSize );
...
//
//  Ptr_Retina createRetina(Size inputSize, bool colorMode, int colorSamplingMethod = RETINA_COLOR_BAYER, bool useRetinaLogSampling = false, float reductionFactor = 1.0f, float samplingStrenght = 10.0f)
//

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetina_11 (JNIEnv*, jclass, jdouble, jdouble, jboolean, jint, jboolean, jfloat, jfloat);

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetina_11
...
{
    static const char method_name[] = "bioinspired::createRetina_11()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::bioinspired::Retina> Ptr_Retina;
        Size inputSize((int)inputSize_width, (int)inputSize_height);
        Ptr_Retina _retval_ = cv::bioinspired::createRetina( inputSize, (bool)colorMode, (int)colorSamplingMethod, (bool)useRetinaLogSampling, (float)reductionFactor, (float)samplingStrenght );
        return (jlong)(new Ptr_Retina(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetina_12 (JNIEnv*, jclass, jdouble, jdouble, jboolean);

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createRetina_12
  (JNIEnv* env, jclass , jdouble inputSize_width, jdouble inputSize_height, jboolean colorMode)
{
    static const char method_name[] = "bioinspired::createRetina_12()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::bioinspired::Retina> Ptr_Retina;
        Size inputSize((int)inputSize_width, (int)inputSize_height);
        Ptr_Retina _retval_ = cv::bioinspired::createRetina( inputSize, (bool)colorMode );
        return (jlong)(new Ptr_Retina(_retval_));
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
...
//
//  Ptr_TransientAreasSegmentationModule createTransientAreasSegmentationModule(Size inputSize)
//

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createTransientAreasSegmentationModule_10 (JNIEnv*, jclass, jdouble, jdouble);

JNIEXPORT jlong JNICALL Java_org_opencv_bioinspired_Bioinspired_createTransientAreasSegmentationModule_10
  (JNIEnv* env, jclass , jdouble inputSize_width, jdouble inputSize_height)
{
    static const char method_name[] = "bioinspired::createTransientAreasSegmentationModule_10()";
    try {
        LOGD("%s", method_name);
        typedef Ptr<cv::bioinspired::TransientAreasSegmentationModule> Ptr_TransientAreasSegmentationModule;
        Size inputSize((int)inputSize_width, (int)inputSize_height);
        Ptr_TransientAreasSegmentationModule _retval_ = cv::bioinspired::createTransientAreasSegmentationModule( inputSize );
