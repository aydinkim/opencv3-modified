...
OPENCV_BASEDIR:="/home/aydinkim/clab/opencv-3.0.0-android"
OPENCV_LOCAL_C_INCLUDES:="/home/aydinkim/clab/opencv-3.0.0-android/platforms/build_android_arm" "/home/aydinkim/clab/opencv-3.0.0-android/include" "/home/aydinkim/clab/opencv-3.0.0-android/include/opencv"
OPENCV_MODULES:=stitching superres videostab adas aruco bgsegm bioinspired ccalib datasets dnn dpm face objdetect line_descriptor optflow reg saliency stereo structured_light rgbd surface_matching text tracking xfeatures2d shape video ximgproc calib3d features2d ml flann xobjdetect xphoto highgui videoio imgcodecs photo imgproc core hal
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    ...
    ifeq ($(TARGET_ARCH_ABI),armeabi-v7a)
        OPENCV_3RDPARTY_COMPONENTS:=libjpeg libwebp libpng libtiff libjasper IlmImf libprotobuf
